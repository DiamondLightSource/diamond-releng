...
if (founddesc) {
   ...
   out.println "[set-build-description_buildstep.groovy] Build description was set to: " + match[0][1]
} else {
   out.println "[set-build-description_buildstep.groovy] No build description found to set"
}
