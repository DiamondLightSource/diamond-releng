...
if (founddesc) {
   ...
   out.println "[SetBuildDescriptionBuildstep] Build description was set to: " + match[0][1]
} else {
   out.println "[SetBuildDescriptionBuildstep] No build description found to set"
}
