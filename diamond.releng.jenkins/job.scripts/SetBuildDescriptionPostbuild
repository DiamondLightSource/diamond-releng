...
if (founddesc) {
   ...
   manager.listener.logger.println "[set-build-description_postbuild.groovy] Build description was set to: " + match[0][1]
} else {
   manager.listener.logger.println "[set-build-description_postbuild.groovy] No build description found to set"
}
